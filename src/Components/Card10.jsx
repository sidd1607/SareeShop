...
export default function ImgMediaCard10({ tags = ["south"] }) {
    ...
    <>
      <Card sx={{ maxWidth: 345 }}>
        <CardMedia
          ...
          alt="Silk saree"
          height="280"
          image="https://www.deepam.com/cdn/shop/articles/kanjeevaram_south_indian_bridal_saree.jpg?v=1663655049"
        />
        <CardContent>
          <Typography
            gutterBottom
          ...
          <Typography variant="body2" sx={{ color: "brown" }}>
            <b>ProductId:110 </b>South indian sarees are luxurious, smooth
